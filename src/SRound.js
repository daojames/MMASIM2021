...
class Round extends React.Component {
    ...
    getOppHitMax(att) {
        ...
        else if (att == 'LOW KICK' || att == 'TAKEDOWN' || att == 'CLINCH') {
            return 1;
        }
        else {
            return 4;
        ...
        return(
            <div className="App-header1">
                ...
                <div className="App-customize1a" style={{marginTop: -60}}>
                    <Link to='./sround'><Button data-tip data-for="4" style={(sessionStorage.getItem('win') == 1 || sessionStorage.getItem('win1') == 1 || sessionStorage.getItem('bell') == 1) ? {border: '2px solid gray', color: 'gray'} : {}} onClick={this.mover0}>{(this.pos() == 0) ? 'STICK' : (this.pos() == 1) ? 'KNEE' : 'STALL'}</Button></Link>
                    ...
                    <Link to='./sround'><Button data-tip data-for="1" style={(sessionStorage.getItem('win') == 1 || sessionStorage.getItem('win1') == 1 || sessionStorage.getItem('bell') == 1) ? {border: '2px solid gray', color: 'gray'} : {}} onClick={this.mover1}>{(this.pos() == 0) ? sessionStorage.getItem('att1') : (this.pos() == 1) ? 'ELBOW' : (this.pos() == 2) ? 'ESCAPE' : 'GET UP'}</Button></Link>
                    ...
                    <Link to='./sround'><Button data-tip data-for="2" style={(sessionStorage.getItem('win') == 1 || sessionStorage.getItem('win1') == 1 || sessionStorage.getItem('bell') == 1) ? {border: '2px solid gray', color: 'gray'} : {}} onClick={this.mover2}>{(this.pos() == 0) ? sessionStorage.getItem('att2') : (this.pos() == 1) ? 'EXIT' : (this.pos() == 2) ? 'REVERSE' : 'G & P'}</Button></Link>
                    ...
                    <Link to='./sround'><Button data-tip data-for="3" style={(sessionStorage.getItem('win') == 1 || sessionStorage.getItem('win1') == 1 || sessionStorage.getItem('bell') == 1) ? {border: '2px solid gray', color: 'gray'} : {}} onClick={this.mover3}>{(this.pos() == 0) ? sessionStorage.getItem('att3') : (this.pos() == 1) ? 'TRIP' : (this.pos() == 2) ? 'SUBMISSION' : 'SUBMISSION'}</Button></Link>
                ...
                <div className="App-customize1a" style={{marginTop: 0}}>
                    <Link to={(sessionStorage.getItem('win') == 1 || sessionStorage.getItem('win1') == 1 || sessionStorage.getItem('dec') == 1) ? './sresults' : './sround'}><Button style={(sessionStorage.getItem('win') == 0 && sessionStorage.getItem('win1') == 0 && sessionStorage.getItem('bell') == 0) ? {border: '2px solid gray', color: 'gray'} : {}} onClick={this.nextRound}><text>NEXT</text></Button></Link>
                </div>
            </div>
        )
    }
