...
class Fighter5 extends React.Component {
    weightCalc(str) {
        if(str == "FLYWEIGHT"){
            return '125';
        }
    ...
    getFirst(str) {
        let data = '';
        if(str == 1){
            data = sessionStorage.getItem('fly5');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 2) {
            data = sessionStorage.getItem('ban5');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 3) {
            data = sessionStorage.getItem('fea5');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 4) {
            data = sessionStorage.getItem('lig5');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 5) {
            data = sessionStorage.getItem('wel5');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 6) {
            data = sessionStorage.getItem('mid5');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 7) {
            data = sessionStorage.getItem('lhe5');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 8) {
            data = sessionStorage.getItem('hea5');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 9) {
            data = sessionStorage.getItem('wst5');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 10) {
            data = sessionStorage.getItem('wfl5');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 11) {
            data = sessionStorage.getItem('wba5');
            data = JSON.parse(data);
            return data.first;
        }
    }
