...
class Fighter10 extends React.Component {
    weightCalc(str) {
        if(str == "FLYWEIGHT"){
            return '125';
        }
    ...
    getFirst(str) {
        let data = '';
        if(str == 1){
            data = sessionStorage.getItem('fly10');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 2) {
            data = sessionStorage.getItem('ban10');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 3) {
            data = sessionStorage.getItem('fea10');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 4) {
            data = sessionStorage.getItem('lig10');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 5) {
            data = sessionStorage.getItem('wel10');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 6) {
            data = sessionStorage.getItem('mid10');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 7) {
            data = sessionStorage.getItem('lhe10');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 8) {
            data = sessionStorage.getItem('hea10');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 9) {
            data = sessionStorage.getItem('wst10');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 10) {
            data = sessionStorage.getItem('wfl10');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 11) {
            data = sessionStorage.getItem('wba10');
            data = JSON.parse(data);
            return data.first;
        }
    }
