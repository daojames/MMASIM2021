            ...
            <div className="App">
                <div className="App-twitter">
                    ...
                    <div className="App-customize4" style={{marginTop: 160}}>
                        <Button7R><text class="alignleft">{ws}<b>{first} {last}</b> @{this.uncapitalize(first)}{this.uncapitalize(last)}mma<br/>{ws}{twt4.msg}<br/>{ws}<text style={{fontSize: 20}}><b>{twt4.month} {twt4.year}{ws2}•{ws2}{twt4.replies} REPLIES</b></text></text></Button7R>
                    </div>
                    <div className="App-customize4" style={{marginTop: -550}}>
                        <Button7><text class="alignleft">{ws}<b>{twt4.rfirst} {twt4.rlast}</b> {this.rTag(twt4)}<br/>{ws}{twt4.rmsg}<br/>{ws}<text style={{fontSize: 20}}><b>{this.rDat(twt4)}{this.rRep(twt4)}</b></text></text></Button7>
                    </div>
