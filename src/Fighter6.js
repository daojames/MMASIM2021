...
class Fighter6 extends React.Component {
    weightCalc(str) {
        if(str == "FLYWEIGHT"){
            return '125';
        }
    ...
    getFirst(str) {
        let data = '';
        if(str == 1){
            data = sessionStorage.getItem('fly6');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 2) {
            data = sessionStorage.getItem('ban6');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 3) {
            data = sessionStorage.getItem('fea6');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 4) {
            data = sessionStorage.getItem('lig6');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 5) {
            data = sessionStorage.getItem('wel6');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 6) {
            data = sessionStorage.getItem('mid6');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 7) {
            data = sessionStorage.getItem('lhe6');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 8) {
            data = sessionStorage.getItem('hea6');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 9) {
            data = sessionStorage.getItem('wst6');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 10) {
            data = sessionStorage.getItem('wfl6');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 11) {
            data = sessionStorage.getItem('wba6');
            data = JSON.parse(data);
            return data.first;
        }
    }
