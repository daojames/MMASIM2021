...
class Replies2 extends React.Component { 
    calcMonth(month){
        switch(month){
            case '1':
                return 'JANUARY';
            ...
            <div className="App">
                <div className="App-twitter">
                    ...
                    <div className="App-customize4" style={{marginTop: 160}}>
                        <Button7R><text class="alignleft">{ws}<b>{first} {last}</b> @{this.uncapitalize(first)}{this.uncapitalize(last)}mma<br/>{ws}{twt2.msg}<br/>{ws}<text style={{fontSize: 20}}><b>{twt2.month} {twt2.year}{ws2}•{ws2}{twt2.replies} REPLIES</b></text></text></Button7R>
                    </div>
                    <div className="App-customize4" style={{marginTop: -550}}>
                        <Button7><text class="alignleft">{ws}<b>{twt2.rfirst} {twt2.rlast}</b> {this.rTag(twt2)}<br/>{ws}{twt2.rmsg}<br/>{ws}<text style={{fontSize: 20}}><b>{this.rDat(twt2)}{this.rRep(twt2)}</b></text></text></Button7>
                    </div>
