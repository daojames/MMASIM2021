                ...
                <div className="App-header">
                    <div className="App-header2">
                        ...
                        <div className="Record" style={{ marginTop: 10 }}>
                            {(true) ? <div><Button5a>{w}28-6</Button5a><Button5b>CONOR MCGREGOR</Button5b><Button5c>WIN • TKO • R1</Button5c><Button5d>UFC 264</Button5d><Button5e>JUL 2021{w}</Button5e></div> : <Button7></Button7>}
                        </div>
                        <div className="Record">
                            {(true) ? <div><Button5a>{w}27-6</Button5a><Button5b>CONOR MCGREGOR</Button5b><Button5c>WIN • KO • R2</Button5c><Button5d>UFC 257</Button5d><Button5e>JAN 2021{w}</Button5e></div> : <Button7></Button7>}
                        </div>
                        <div className="Record">
                            {(true) ? <div><Button5a>{w}26-6</Button5a><Button5b>DAN HOOKER</Button5b><Button5c>WIN • DEC • R5</Button5c><Button5d>UFC 250</Button5d><Button5e>JUN 2020{w}</Button5e></div> : <Button7></Button7>}
                        </div>
                        <div className="Record">
                            {(true) ? <div><Button6a>{w}25-6</Button6a><Button6b>KHABIB NURMAGOMEDOV</Button6b><Button6c>LOSS • SUB • R3</Button6c><Button6d>UFC 242</Button6d><Button6e>SEP 2019{w}</Button6e></div> : <Button7></Button7>}
                        </div>
                        <div className="Record">
                            <Button5></Button5>
                        </div>
