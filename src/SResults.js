...
class Results extends React.Component {
    ...
    handleFight = (event) => {
        ...
        data = JSON.parse(data);
        let oppNum = parseInt(sessionStorage.getItem('oppNum'));
        let opp = null;

        if (data.weight != 'WSTRAWWEIGHT' && data.weight != 'WFLYWEIGHT' && data.weight != 'WBANTAMWEIGHT') {
            opp = JSON.parse(returnFighterM(oppNum));
            if (sessionStorage.getItem('win') == 1) {
                console.log('opp sloss: ' + opp.sloss);
                opp.sloss = parseInt(opp.sloss) + 1;
                console.log('opp sloss: ' + opp.sloss);
            }
            else {
                opp.swin = parseInt(opp.swin) + 1;
            }
            let str = 'nr' + oppNum;
        ...
        if (sessionStorage.getItem('win') == 1) {
            ...
            sessionStorage.setItem('playerSwin', parseInt(sessionStorage.getItem('playerSwin')) + 1);
            ...
            sessionStorage.setItem('playerSloss', parseInt(sessionStorage.getItem('playerSloss')) + 1);
        ...
        switch (parseInt(sessionStorage.getItem('month'))) {
            case 1:
                if (sessionStorage.getItem('win') == 1) {
                    sessionStorage.setItem('w1res', 1);
                }
                else {
                    sessionStorage.setItem('w1res', 0);
                }
                break;
            case 2:
                if (sessionStorage.getItem('win') == 1) {
                    sessionStorage.setItem('w2res', 1);
                }
                else {
                    sessionStorage.setItem('w2res', 0);
                }
                break;
            case 3:
                if (sessionStorage.getItem('win') == 1) {
                    sessionStorage.setItem('w3res', 1);
                }
                else {
                    sessionStorage.setItem('w3res', 0);
                }
                break;
            case 4:
                if (sessionStorage.getItem('win') == 1) {
                    sessionStorage.setItem('w4res', 1);
                }
                else {
                    sessionStorage.setItem('w4res', 0);
                }
                break;
            case 5:
                if (sessionStorage.getItem('win') == 1) {
                    sessionStorage.setItem('w5res', 1);
                }
                else {
                    sessionStorage.setItem('w5res', 0);
                }
                break;
            case 6:
                if (sessionStorage.getItem('win') == 1) {
                    sessionStorage.setItem('w6res', 1);
                }
                else {
                    sessionStorage.setItem('w6res', 0);
                }
                break;
            case 7:
                if (sessionStorage.getItem('win') == 1) {
                    sessionStorage.setItem('w7res', 1);
                }
                else {
                    sessionStorage.setItem('w7res', 0);
                }
                break;
            case 8:
                if (sessionStorage.getItem('win') == 1) {
                    sessionStorage.setItem('w8res', 1);
                }
                else {
                    sessionStorage.setItem('w8res', 0);
                }
                break;
        }
                ...
                case 1:
                    if (sessionStorage.getItem('win') == 1) {
                        if (ko == 1 || tko == 1) {
                            ...
                            sessionStorage.setItem('playerPts', parseInt(sessionStorage.getItem('playerPts')) + 6);
                        }
                        else if (sub == 1){
                            ...
                            sessionStorage.setItem('playerPts', parseInt(sessionStorage.getItem('playerPts')) + 3);
                        }
                    }
                    else {
                        if (ko == 1 || tko == 1) {
                ...
                case 2:
                    if (sessionStorage.getItem('win') == 1) {
                        if (ko == 1 || tko == 1) {
                            ...
                            sessionStorage.setItem('playerPts', parseInt(sessionStorage.getItem('playerPts')) + 5);
                        }
                        else if (sub == 1){
                            sessionStorage.setItem('winSUB', parseInt(sessionStorage.getItem('winSUB')) + 1);
                            sessionStorage.setItem('fin2', parseInt(sessionStorage.getItem('fin2')) + 1);
                ...
                case 3:
                    if (sessionStorage.getItem('win') == 1) {
                        if (ko == 1 || tko == 1) {
                            ...
                            sessionStorage.setItem('playerPts', parseInt(sessionStorage.getItem('playerPts')) + 4);
                        }
                        else if (sub == 1){
                            sessionStorage.setItem('winSUB', parseInt(sessionStorage.getItem('winSUB')) + 1);
                            sessionStorage.setItem('fin3', parseInt(sessionStorage.getItem('fin3')) + 1);
                ...
                <div className="App-header">
                    <div className="App-header-styleTop">
                        ...
                        <div className="App-customize2-0" style={{marginTop: 0}}>
                            ...
                            <Button1f></Button1f>
                            <Button1cr><text style={{color: 'gray'}}>$0</text></Button1cr>
                        </div>
                        <div className="App-customize2-0" style={{marginTop: 0}}>
