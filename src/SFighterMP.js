...
class SFighterMP extends React.Component {
    weightCalc(str) {
        if(str == "FLYWEIGHT"){
            return '125';
        }
    ...
    render() {
        ...
        if (parseInt(sessionStorage.getItem('sfighter')) == 0) {
            ...
            fighter = JSON.parse(returnFighterM(parseInt(sessionStorage.getItem('sfighter'))));
        }
        return(
            <div className="App">
                <div className="App-header">
                    <div className="App-header-styleTop">
                        ...
                        <div className="Customize-desc1" style={{ textAlign: 'right', marginLeft: 130, marginRight: 120, fontSize: 70, marginTop: -70 }}><text style={{ color: 'grey' }}>{fighter.rank}</text> <b>{fighter.first} {fighter.last}</b> <text style={{ color: 'grey' }}>{fighter.win} - {fighter.loss}</text><br/></div>
                        <Button6></Button6>
                        <Flag style={{ marginTop: -470 }}><img src={getFlag(10)} width="123" height="70"></img></Flag>
                        ...
                        <div className="App-customize3" style={{marginTop: -20}}>
                            <Button2><b>{fighter.rate}%</b></Button2>
                            <Button2><b>{fighter.ko}</b></Button2>
                            <Button2><b>{fighter.sub}</b></Button2>
                            <Button2><b>{this.getWeight()}</b></Button2>
                            <Button2><b>{this.getHeight(fighter.height)}</b></Button2>
                        </div>
                        ...
                        <div className="App-customize3" style={{marginTop: -20}}>
                            <Button2><b>{fighter.strength}</b></Button2>
                            <Button2><b>{fighter.speed}</b></Button2>
                            <Button2><b>{fighter.stamina}</b></Button2>
                        </div>
                        <div className="App-customize2" style={{marginTop: 25}}>
                        ...
                        <div className="App-customize3" style={{marginTop: -20}}>
                            <Button2><b>{fighter.punching}</b></Button2>
                            <Button2><b>{fighter.kicking}</b></Button2>
                            <Button2><b>{fighter.wrestling}</b></Button2>
                            <Button2><b>{fighter.grappling}</b></Button2>
                            <Button2><b>{fighter.clinch}</b></Button2>
                        </div>
                    ...
                    <div className="Customize-desc1" style={{ textAlign: 'right', marginLeft: 0, marginRight: 0, marginTop: 837 }}>
                        ...
                        <Link to='./playoffspfl'><Button4>BACK</Button4></Link>
