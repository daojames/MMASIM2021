            ...
            <div className="App">
                <div className="App-header">
                    <div className="App-header-styleTop">
                        ...
                        <div className="Customize-desc1" style={{ textAlign: 'right', marginLeft: 130, marginRight: 120, fontSize: 70, marginTop: -70 }}><b>{fighter.first} {fighter.last}</b><br/></div>
                        <Button6>{fighter.nation}</Button6>
                        ...
                        <div className="App-customize3" style={{marginTop: -20}}>
                            <Button2><b>{fighter.rank}</b></Button2>
                            <Button2><b>{fighter.win}</b></Button2>
                            <Button2><b>{fighter.loss}</b></Button2>
