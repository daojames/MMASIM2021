...
class Fighter7 extends React.Component {
    weightCalc(str) {
        if(str == "FLYWEIGHT"){
            return '125';
        }
    ...
    getFirst(str) {
        let data = '';
        if(str == 1){
            data = sessionStorage.getItem('fly7');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 2) {
            data = sessionStorage.getItem('ban7');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 3) {
            data = sessionStorage.getItem('fea7');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 4) {
            data = sessionStorage.getItem('lig7');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 5) {
            data = sessionStorage.getItem('wel7');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 6) {
            data = sessionStorage.getItem('mid7');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 7) {
            data = sessionStorage.getItem('lhe7');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 8) {
            data = sessionStorage.getItem('hea7');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 9) {
            data = sessionStorage.getItem('wst7');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 10) {
            data = sessionStorage.getItem('wfl7');
            data = JSON.parse(data);
            return data.first;
        }
        else if(str == 11) {
            data = sessionStorage.getItem('wba7');
            data = JSON.parse(data);
            return data.first;
        }
    }
