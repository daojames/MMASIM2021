...
class SFighterFP extends React.Component {
    weightCalc(str) {
        if(str == "FLYWEIGHT"){
            return '125';
        }
            ...
            <div className="App">
                <div className="App-header">
                    <div className="App-header-styleTop">
                        ...
                        <Button6></Button6>
                        <Flag style={{ marginTop: -470 }}><img src={getFlag(11)} width="123" height="70"></img></Flag>
                    ...
                    <div className="Customize-desc1" style={{ textAlign: 'right', marginLeft: 0, marginRight: 0, marginTop: 837 }}>
                        ...
                        <Link to='./playoffspflf'><Button4>BACK</Button4></Link>
